...
\employer{Root Insurance}{2020-current}{Software Engineer}
	...
	\end{achievements}
\employer{Pillar Technology}{2018-2020}{Software Artisan / Technical lead}
	\begin{achievements}
	...
	\end{achievements}
\employer{Pillar Technology}{2015-2018}{Software Artisan}
	\begin{achievements}
	...
	\end{achievements}
% \employer{pillar technology}{2020}{principal software artisan technical lead}
% 	\begin{achievements}
% 	\end{achievements}
% \employer{pillar technology}{2018-2020}{senor software artisan / technical lead}
% 	\begin{achievements}
% 	\end{achievements}
% \employer{pillar technology}{2016-2018}{software artisan / technical lead}
% 	\begin{achievements}
% 	\end{achievements}
% \employer{pillar technology}{2016-2018}{software artisan}
% 	\begin{achievements}
% 	\end{achievements}
% \employer{pillar technology}{2015-2016}{apprentice software artisan}
% 	\begin{achievements}
% 	\end{achievements}
