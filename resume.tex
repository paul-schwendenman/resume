...
\employer{Root Insurance}{2020-current}{Software Engineer}
	...
	\end{achievements}
\employer{Pillar Technology}{2015-2020}{Senor Software Artisan / Technical lead}
	\begin{achievements}
	\item Worked on many different clients and teams to rapidly develop valuable working code
	...
	\item Helped to create a React based data visualization tool
	\end{achievements}
\jobtitle{Software Artisan}
	\begin{achievements}
	\item Responsible for writing high quality code that would solve valuable business problems
	\item Responsible for peer up lift and helping to foster a healthy team environment
	\item Responsible for building a client relationship around trust and results
	\item Responsible for creating an application to manage vulnerabilities returned on a vulnerability scan
	\item Responsible for creating an application used to research suspicious network activity
...
\header{Skills}
\begin{achievements}
	\item python, javascript, node.js, react, HTML, CSS, ruby, docker, bash,
	\item bootstrap, postgreSQL, mongoDB, nginx, Apache, \LaTeX
	\item unix tools, GNU/Linux, git, regular expressions, agile methodology
\end{achievements}
